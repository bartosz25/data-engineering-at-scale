...
if __name__ == '__main__':
    ...
    def print_visit_rows_from_foreach_partition(visits: DataFrame, batch_number: int):
        print(f'✍️ Batch#{batch_number} Printing visits from a micro-batch partition')
    ...
    write_data_stream = (visits_from_kafka.writeStream
                         #commented, it should process data ASAP .trigger(processingTime='20 seconds')
                         .option('checkpointLocation',f'{CHECKPOINTS_DIR}/kafka_consumer_micro_batch')
